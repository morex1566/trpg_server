...
public sealed class NetworkingMethodGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateReceiveMap(SourceProductionContext context, MethodModel[] receiveMethods)
    {
        ...
        source.AppendLine("{");
        source.AppendLine("    public static readonly Dictionary<PayloadType, PacketHandler> receiveMap = new()");
        source.AppendLine("    {");
        ...
        source.AppendLine("}");
        source.AppendLine();
        source.AppendLine("public static class PacketHandleHelper");
        source.AppendLine("{");
        source.AppendLine("    public static PacketHandler? Get(PayloadType payloadType)");
        source.AppendLine("    {");
        source.AppendLine("        if (PacketHandleMap.receiveMap.TryGetValue(payloadType, out var handle))");
